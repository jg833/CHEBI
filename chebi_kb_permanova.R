...
# LOWCHO A vs. C and B vs. C significant.

samples_f <- samples %>% 
  filter(group == 'LOWCHO', trial == 'A' | trial == 'B') # Change group and trial here
...
pvals <- c(0.1365,0.0037 ,0.0372 ,0.2768,0.9426,0.5897,0.427,0.2302,0.2119)

p.adjust(pvals, method = 'BH') # LOWCHO A - C still significant p = 0.0333
...
pvals <- c(0.6598,0.722, 0.967,0.0883, 0.0446, 0.8952,0.6019,0.0218,0.003)
